...
export const en: Strings = {
  ...
  settings: {
    categories: {
      ...
      sync: {
        label: 'Profile Sync',
        sub: 'Carry your settings and scores to another device',
      },
    },
    done: 'Done',
  ...
  editors: {
    ...
    importExport: {
      ...
      confirmBody:
        'This erases every setting - options, controls, players, taunts, and high scores - and restarts the game fresh. It also stops profile sync here, though your online profile is not deleted. This cannot be undone.',
      confirmYes: 'Reset Everything',
      confirmNo: 'Cancel',
    },
    sync: {
      title: 'Profile Sync',
      intro: 'Save your settings, players, taunts and high scores online, then load them on any other device.',
      createDesc: 'Create Profile - save this device online and get an ID',
      linkDesc: 'Load Profile - enter an ID to bring that profile here',
      linkedIntro: 'This device is synced. Changes upload on their own; write the ID down to load it elsewhere.',
      uploadDesc: 'Upload - send your latest changes right now',
      downloadDesc: 'Download - replace this device with the online copy',
      desyncDesc: 'Desync - stop syncing here (nothing is deleted)',
      idLabel: 'Profile ID',
      ...
      idle: 'Create a profile, or load one with its ID',
      working: 'Talking to the server...',
      stateSynced: 'Synced {when}',
      statePending: 'Changes not sent yet - uploading shortly',
      stateConflict: 'Changed on another device - Download to catch up',
      ago: {now: 'just now', minutes: '{n} min ago', hours: '{n} hours ago', days: '{n} days ago'},
      outcome: {
        created: 'Profile created. Write down the ID above!',
        linked: 'Profile loaded. Reloading...',
        uploaded: 'Changes uploaded.',
        downloaded: 'Profile downloaded. Reloading...',
        upToDate: 'Already up to date.',
        conflict: 'This profile changed on another device. Download to catch up.',
        missing: 'No profile has that ID. Check the code and try again.',
        tooLarge: 'This profile is too big to sync.',
        rateLimited: 'Too many requests - wait a minute and try again.',
        offline: 'Could not reach the server. Your data is safe on this device.',
        badData: 'That profile is damaged and was not loaded.',
        badCode: 'That is not a valid profile ID.',
      },
      confirm: {
        link: {
          title: 'Load This Profile?',
          body: 'The settings, players, taunts and high scores on this device will be replaced by the ones stored in that profile. This cannot be undone.',
          yes: 'Load Profile',
        },
        download: {
          title: 'Download Profile?',
          body: 'This device will be replaced by the online copy. Any changes made here that have not been uploaded will be lost.',
          yes: 'Download',
        },
        desync: {
          title: 'Stop Syncing?',
          body: 'This device will stop uploading and forget the profile ID. Nothing is deleted - your settings stay here, and the online copy stays too. You will need the ID to sync again.',
          yes: 'Desync',
        },
      },
      confirmNo: 'Cancel',
