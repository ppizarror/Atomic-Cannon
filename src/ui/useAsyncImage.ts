 ...
 * ignores a result that arrives after unmount / a dep change — one ok-flag guard for every
 * leaf that loads an image (weapon icons, the depot sort arrow, the atom logo, the title
 * reticle tile), rather than the same guard hand-rolled in each of them.
 */
