...
{
  const g = new RenderGate(GRACE);
  g.shouldRedraw(false, false, T); g.shouldRedraw(false, false, T); // settle to idle
...
{
  const g = new RenderGate(GRACE);
  g.shouldRedraw(false, false, T); g.shouldRedraw(false, false, T);   // reach idle
...
{
  const g = new RenderGate(GRACE);
  g.shouldRedraw(false, false, T); g.shouldRedraw(false, false, T);   // idle baseline (far past grace)
